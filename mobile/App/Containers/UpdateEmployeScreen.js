...
// Styles
import styles from './Styles/UpdateEmployeScreenStyle'
...
class UpdateEmployeScreen extends Component {
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      prenom: props.navigation.state.params.prenom,
  ...
  async onSave() {
    ...
    const response = await this.props.updateEmploye({
      variables: {
...
mutation UpdateEmploye($id: ID!, $nom: String, $prenom: String, $age: Int, $poste: String, $experience: String) {
  updateEmploye(id: $id, nom: $nom, prenom: $prenom, age: $age, poste: $poste, experience: $experience) {
    id
  }
}
...
const withUpdateEmploye = graphql(UPDATE_EMPLOYE, { name: 'updateEmploye' })
...
export default connect(mapStateToProps, mapDispatchToProps)(withData(UpdateEmployeScreen))
